...
public class Server extends Application{
	...
	public Server() {
		...
		//attributes.put("LD4Sensors", this);
	...
	public  void prop(ServerProperties properties) throws Exception {
		...
		// Create and store the JAXBContext instances on the server context.
		// They are supposed to be thread safe.
		//Map<String, Object> attributes = this.getContext().getAttributes();
...
//			    router.attach("/ping?user={user}&password={password}", PingResource.class);
				...
				//router.attach("/postdata/", DeviceObservationDataResource.class);
				router.attach("/postdata/{device_id}", DeviceObservationDataResource.class);

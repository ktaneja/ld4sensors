...
public class TestPropertyRestApi extends LD4STestHelper {
	/** Resource ID necessary to store locally. */
	protected String resourceId = "a12b";

	/** LD4S currently running server host. */
	protected String local_uri = "http://localhost:8080/ld4s/sensdev/";
	...
	/** Unit of Measurement. */
	protected String uom = "http://www.example4.org/uom/centigrade";

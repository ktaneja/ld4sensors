...
/**
 * Resource representing data link.
 *
 * @author Myriam Leggieri.
 *
 */
public class LinkResource extends LD4SLinkResource implements LD4SApiInterface{
	...
	public Representation get() {
		...
		try {
			...
			if (!this.context.isEmpty()){
				...
				rdfData = (OntModel)addLinkedData(rdfData.getResource(uristr), Domain.ALL, this.context, rdfData)[0];
			}
...
//	}
	...
	public Representation put(Form obj){
		...
		logger.fine(resourceName + " LD4S: Now building LD4S.");
		try {
			this.ov = new Link(obj, this.ld4sServer.getHostName());

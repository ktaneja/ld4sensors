...
public class TestLinkRestApi extends LD4STestHelper {
	...
	protected String local_uri = "http://localhost:8182/ld4s/link/";
...
//			}
			...
			for (int i=0; i<feedbacks.length; i++){
				jarr.put(feedbacks[i]);
			}
			json.append("feedbacks", feedbacks);

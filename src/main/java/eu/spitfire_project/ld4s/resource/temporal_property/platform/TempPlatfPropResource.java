 ...
 *
 */
public class TempPlatfPropResource extends LD4STempPlatfPropResource implements LD4SApiInterface{
...
//	}
	...
	public Representation put(Form obj){
		...
		logger.fine(resourceName + " LD4S: Now building LD4S.");
		try {
			this.ov = new TempPlatfProp(obj, this.ld4sServer.getHostName());

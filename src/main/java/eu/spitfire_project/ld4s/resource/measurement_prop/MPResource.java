package eu.spitfire_project.ld4s.resource.measurement_prop;
...
/**
 * Resource representing measurement capability.
 *
 * @author Myriam Leggieri.
 *
 */
public class MPResource extends LD4SMPResource implements LD4SApiInterface{
	...
	public Representation get() {
		...
		try {
			...
			rdfData = retrieve(this.uristr, this.namedModel, this.sparqlEndpoitUri);
